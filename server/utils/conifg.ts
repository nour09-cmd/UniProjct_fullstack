...
export const FRONDENDSUPPORT = "http://localhost/contact";
export const FRONDENDLOGIN = "http://localhost/Login";
export const TERMINURL = "http://localhost/contact";
export const SHOPNAME = "Barber Finder";
export const SUPPORT = "http://localhost/contact";
